            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Generated and downloadable reports</p>
                </div>
                  ...
                  <tbody>
                    {recentReports.map((report) => (
                      <tr key={report.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-4 px-4 text-gray-600">{report.type}</td>
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center space-x-2">
                            <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" title="View Report">
                              <Eye className="w-4 h-4" />
                            </button>
                            <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" title="Download">
                              <Download className="w-4 h-4" />
              ...
              <form onSubmit={handleSubmitReport}>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Misroutes</label>
                      <input
                        type="number"
                        min="0"
                  ...
                  {/* Vehicle Trips */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-3">Vehicle Trips</label>
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs font-medium text-gray-600 mb-1">2-Wheeler</label>
                        <input
                          type="number"
                          min="0"
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-600 mb-1">3-Wheeler</label>
                        <input
                          type="number"
                          min="0"
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-600 mb-1">4-Wheeler</label>
                        <input
                          type="number"
                          min="0"
